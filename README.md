...
| 3 | **wait 14 s before every try** | every message — and every retry — waits `SEARCH_STEP_DELAY_MS` (default `14000`) first |
...
| `SEARCH_STEP_DELAY_MS` | `14000` | wait before **every** try — the 14 s rule |
