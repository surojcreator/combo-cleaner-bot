...
async function registerCommands() {
    try {
        await bot.telegram.setMyCommands([
            ...
            { command: "lsearch", description: "\uD83D\uDCBE Search biggest cleaned file" },
            { command: "csearch", description: "💎 Search all cleaned files on disk" },
            { command: "vaultsearch", description: "🌐 Search all vault files on disk" },
            { command: "mergeclean", description: "⚡️ Merge cleaned files in vault disk" },
            { command: "removedomain", description: "🗑️ Purge domain credentials from batch" },
